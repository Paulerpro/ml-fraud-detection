...
def main():
    ...
    X_train, X_val, X_test = X_train.values.astype(np.float32), X_val.values.astype(np.float32), X_test.values.astype(np.float32)
    ...
    print("Test AP :", average_precision_score(yt, pt))
